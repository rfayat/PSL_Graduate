...
def empty_substitution_matrix(dtype=int):
    "Return a dataframe filled with zeros whose rows and cols are the amino-acids"  # noqa E501
...
def compute_substition_matrix(sequence_1_all, sequence_2_all):
    ...
    # Compute the substitution count for each pair and add it to the matrix
    for sequence_1 in sequence_1_all:
        for sequence_2 in sequence_2_all:
            substitution_matrix += compute_substitution_count(sequence_1, sequence_2)  # noqa E501
    return substitution_matrix
