...
def load_aln_data(path):
    ...
    for parsed_row in parsed_row_all:
        ...
        sequence_as_list = [amino_acid for amino_acid in parsed_row["sequence"]]  # noqa E501

        # Store the sequence in df
        df.loc[start_position:end_position, parsed_row["organism_id"]] = sequence_as_list  # noqa E501
    return df
